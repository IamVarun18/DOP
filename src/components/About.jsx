...
export default function About() {
  ...
  useEffect(() => {
    ...
    gsap.fromTo(
      ...
      { opacity: 0, x: -30, y: 40 },
      {
        opacity: 1, x: 0, y: 0, duration: 1.2, ease: "power3.out", delay: 0.2,
        scrollTrigger: { trigger: img1Ref.current, start: "top 80%" },
      }
    );
  ...
  return (
    <section ref={sectionRef} className="about" id="about">
      ...
      <div className="about-content">
        <p ref={tagRef} className="about-tag">About</p>
        ...
        <div ref={textRef} className="about-text">
          <p>
            Ashish is a Director of Photography and Director with a passion
            for crafting visuals that move people. Specializing in ad films,
            music videos, and short films — every project is approached with
            intention, precision, and heart.
          </p>
          <p>
            Armed with a Sony cinema rig and a full production team, Ashish
            brings stories to life frame by frame — balancing technical
            mastery with raw creative instinct.
          </p>
        </div>
